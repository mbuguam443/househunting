    ...
    >
      <View style={styles.inner}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Landlord Portal</Text>
        </View>
        <TextInput
          style={styles.input}
